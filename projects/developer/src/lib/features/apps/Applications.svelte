  ...
  <div class="content">
    ...
    {:else if selected}
      <div class="detail-grid">
        <section class="panel">
          {#each [{ label: "App name", value: selected.name, code: false }, { label: "Description", value: selected.description || "No description yet.", code: false }, { label: "Redirect URIs", value: selected.redirect_uri, code: true }, { label: "Allowed origins", value: selected.origins.join("\n") || "No origins configured", code: true }] as field}
          ...
          {/each}
          {#each [{ label: "Client ID", value: selected.client_id, secret: false }, { label: "Client Secret", value: selected.client_secret, secret: true }] as field}
            <div class="credential">
              <strong>{field.label}</strong>
              <div class="credential-value">
                <code
